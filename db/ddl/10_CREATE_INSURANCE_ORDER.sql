CREATE TABLE PUBLIC.INSURANCE_ORDER (
  ...
  KANJI_FIRST_NAME VARCHAR(120) NOT NULL,

  KANA_NAME VARCHAR(180) NOT NULL,

  KANA_FAMILY_NAME VARCHAR(180) NOT NULL,
  KANA_FIRST_NAME VARCHAR(180) NOT NULL,

  ALPHABET_NAME VARCHAR(120) NOT NULL,

  ALPHABET_FAMILY_NAME VARCHAR(120) NOT NULL,
  ALPHABET_FIRST_NAME VARCHAR(120) NOT NULL,
  ...
  ADDRESS1 VARCHAR(510) NOT NULL,
  ADDRESS2 VARCHAR(510) NOT NULL,
...
COMMENT ON column PUBLIC.INSURANCE_ORDER.KANJI_FAMILY_NAME is '漢字性';
COMMENT ON column PUBLIC.INSURANCE_ORDER.KANJI_FIRST_NAME is '漢字名';

COMMENT ON column PUBLIC.INSURANCE_ORDER.KANA_NAME is 'カナ氏名';

COMMENT ON column PUBLIC.INSURANCE_ORDER.KANA_FAMILY_NAME is 'カナ性';
COMMENT ON column PUBLIC.INSURANCE_ORDER.KANA_FIRST_NAME is 'カナ名';

COMMENT ON column PUBLIC.INSURANCE_ORDER.ALPHABET_NAME is '英字氏名';

COMMENT ON column PUBLIC.INSURANCE_ORDER.ALPHABET_FAMILY_NAME is '英字性';
COMMENT ON column PUBLIC.INSURANCE_ORDER.ALPHABET_FIRST_NAME is '英字名';
...
COMMENT ON column PUBLIC.INSURANCE_ORDER.ADDRESS1 is '住所1';
COMMENT ON column PUBLIC.INSURANCE_ORDER.ADDRESS2 is '住所2';
